...
const Pin = ( {pin: {postedBy, image, _id, destination, save} }) => {
    ...
    //user info from ../utils/fetchUser.js
    ...
    const savePin = (id) => {
        if(!alreadySaved) {
            ...
            client
                //Patch the post with an ID.
                .patch(id)
                //Add an array if misisng.
                .setIfMissing({ save: [] })
                //Insert a document.
                .insert('after', 'save[-1]', [{
                    _key: uuidv4(),
                ...
                //Commit the changes.
                .commit()
                //Reload the window to show the changes.
                .then(() => {
    ...
    return (
        <div className='m-2'>
            ...
            {/* Add the postedBy profile beneath the pin. */}
